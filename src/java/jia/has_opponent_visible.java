...
/**
 * Returns true or false indicating if exists an opponent in agent's visibility range.
 * </p>
 * Use: jia.jia.has_opponent_visible(+R);</br>
 * Where: R is agent's visibility range.
 * 
 * @author mafranko
 */
